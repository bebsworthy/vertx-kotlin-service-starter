...
/** @module paths-js/sample_service */
...
SampleService._jtype = {
  ...
  wrap: function(jdel) {
    var obj = Object.create(SampleService.prototype, {});
    SampleService.apply(obj, arguments);
    return obj;
  },
  unwrap: function(obj) {
    return obj._jdel;
...
SampleService._create = function(jdel) {
  var obj = Object.create(SampleService.prototype, {});
  SampleService.apply(obj, arguments);
  return obj;
}
